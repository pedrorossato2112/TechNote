...
<section class="produtos">
    ...
    <?php if (empty($filtrados)) { ?>
        ...
        <div class="sem-resultados">
            ...
            <p>
                Nenhum notebook encontrado para
                "<strong><?php echo htmlspecialchars($busca); ?></strong>".
            </p>

            <a href="notebooks.php" class="btn">
                Ver todos
            </a>
        ...
        <div class="card technote-card">
            ...
            <?php } else { ?>
                ...
                <span
                    ...
                    style="background:#ffd000; color:#0a0a0a;"
                >
                    Em estoque
                </span>
            ...
            <img
                ...
                class="card-img-top"
                alt="<?php echo htmlspecialchars($notebook['nome']); ?>"
            >
            ...
            <div class="card-body">
                ...
                <h3 class="card-title">
                    <?php echo htmlspecialchars($notebook['nome']); ?>
                </h3>

                <p class="card-text">
                    <?php echo htmlspecialchars($notebook['marca']); ?>
                    · Estoque:
                    <?php echo $notebook['estoque']; ?>
                    unidades
                </p>
                ...
                <?php if ($usuarioLogado) { ?>
                    ...
                    <span class="preco">
                        R$
                        <?php echo number_format($notebook['preco'], 2, ',', '.'); ?>
                    </span>

                <?php } else { ?>

                    <a href="login.php" class="preco preco-bloqueado">
                        R$ 0.000,00
                        <span class="cadeado">🔒</span>
                    </a>

                    <small class="mensagem-login">
                ...
                <?php if ($notebook['estoque'] > 0) { ?>
                    ...
                    <?php if ($usuarioLogado) { ?>
                        ...
                        <a
                            href="adicionar_carrinho.php?id=<?php echo $notebook['id']; ?>"
                            class="btn-card"
                        >
